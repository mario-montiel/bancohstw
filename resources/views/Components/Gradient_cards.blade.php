...
<div class="row">
    ...
    <div class="col-md-6 mb-4">
        ...
        <div class="card gradient-card">
            ...
            <div class="card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg)">
                ...
                <!-- Content -->
                <a href="{{ url('/asignar_prestamos') }}">
                    <div class="text-white d-flex h-100 mask blue-gradient-rgba">
                        <div class="first-content align-self-center p-3">
                            <h3 class="card-title">Prestamos</h3>
                            <p class="lead mb-0">Pide tu prestamo Hoy!</p>
                        </div>
            ...
            <div class="card-body white">
                <div class="progress md-progress">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 99%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-muted">Porcentajes de aceptacion de prestamo del 99%</p>
    ...
    <div class="col-md-6 mb-4">
        ...
        <div class="card gradient-card">
            ...
            <div class="card-body white">
                <div class="progress md-progress">
                    <div class="progress-bar purple lighten-2" role="progressbar" style="width: 95%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-muted">Tarjetas validas en el 95% de las sucursales</p>
                <h4 class="text-uppercase font-weight-bold my-4">Detalles</h4>
                <p class="text-muted" align="justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam vel dolores qui, necessitatibus aut eaque magni mollitia tenetur molestiae sit quae quos quaerat amet exercitationem atque animi odio.</p>
            </div>
